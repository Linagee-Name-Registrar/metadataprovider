...
app.get('/image/:id',function(req,res){
    ...
    try{
        ...
        if(warning == "Yes"){
            color1= "#ff6062"
            color2= "#ff9766"
            warninghint = '<text style="fill: rgb(255, 255, 255); font-family: Roboto, sans-serif; font-size: 80px; white-space: pre;text-align:center;width:100%" text-anchor="middle" x="50%" y="30%">⚠</text>';
        }
        ...
        let svg = '<?xml version="1.0" encoding="utf-8"?>\n' +
            ...
            warninghint +
            '  <text style="fill: rgb(255, 255, 255); font-family: Roboto, sans-serif; font-size: '+fsize+'px; letter-spacing:3px;white-space: pre;text-align:center;width:100%" text-anchor="middle" x="50%" y="80%">'+escapeHtml(domainname + '.og')+'</text>\n' +
            '</svg>'
