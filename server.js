...
app.get('/image/:id',function(req,res){
    ...
    try{
        ...
        let svg = '<?xml version="1.0" encoding="utf-8"?>\n' +
            ...
            warninghint +
            '  <text style="fill: rgb(255, 255, 255); font-family: Roboto; font-size: '+fsize+'px; letter-spacing:3px;white-space: pre;text-align:center;width:100%" text-anchor="middle" x="50%" y="80%">'+escapeHtml(domainname + '.og')+'</text>\n' +
            '</svg>'
